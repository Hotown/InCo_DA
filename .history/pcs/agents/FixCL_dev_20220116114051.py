...
class DEVAgent(BaseAgent):
    ...
    def train_one_epoch(self):
        ...
        for batch_i in range(num_batches):
            ...
            update_mix_source = update_data_memory(mix_proto_source.as_tensor(), update_mix_source, m)
            update_mix_target = update_data_memory(mix_proto_target.as_tensor(), update_mix_target)
            ...
            #     update_mix_source = domain_m_dict["source"] * proto_source + (1 - domain_m_dict["target"]) * proto_target
            #     update_mix_target = domain_m_dict["target"] * proto_source + domain_m_dict["source"] * proto_target
            ...
            #     mix_source.update(idx, update_mix_target)
            #     mix_target.update(idx, update_mix_target)
